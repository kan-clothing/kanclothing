...
<body>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">
                                    <div class="product__thumb__pic set-bg" data-setbg="img/shop-details/dyob1-prev1.jpg">
                                    </div>
                                </a>
                            </li>                        
                        </ul>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                <div class="product__details__pic__item">
                                    <img src="img/shop-details/dyob1-prev1.jpg" alt="">
                                </div>
                            </div>                       
                        </div>
                    </div>
    ...
    <h4>Kan Dyob - White</h4>
    <h3>₱549.00</h3>
    <p>This is a silkscreen-printed T-Shirt with the logo printed on the front, and a model on the back. This is made out of 100% cotton, providing comfort and style to your fit.</p>
    ...
    <div class="product__details__cart__option">
        ...
        <button type="button" class="primary-btn add-to-cart-btn" id="add-to-cart-btn2" onclick="addProductToCart('product2');">add to cart</button>
    </div>

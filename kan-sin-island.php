...
<body>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">
                                    <div class="product__thumb__pic set-bg" data-setbg="img/shop-details/sin-prev1.jpg">
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-2" role="tab">
                                    <div class="product__thumb__pic set-bg" data-setbg="img/shop-details/sin-prev2.jpg">
                                    </div>
                                </a>
                            </li>                          
                        </ul>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                <div class="product__details__pic__item">
                                    <img src="img/shop-details/sin-prev1.jpg" alt="">
                                </div>
                            </div>
                            <div class="tab-pane" id="tabs-2" role="tabpanel">
                                <div class="product__details__pic__item">
                                    <img src="img/shop-details/sin-prev2.jpg" alt="">
                                </div>
                            </div>                          
                        </div>
                    </div>
    ...
    <div class="product__details__cart__option">
        ...
        <button type="button" class="primary-btn" id="add-to-cart-btn13" onclick="addProductToCart('product13');">add to cart</button>
    </div>
